...
class Order(AbstractBaseModel):
    ...
    ORDER_STATUS_CHOICES = [
        {'value': 'در حال پردازش', 'display': 'Pending'},
        {'value': 'ارسال شده', 'display': 'Shipped'},
        {'value': 'تحویل شده', 'display': 'Delivered'},
        {'value': 'لغو شده', 'display': 'Unsuccessful'},
    ]
    ...
    order_status = models.CharField(max_length=20, choices=ORDER_STATUS_CHOICES, default='در حال پردازش')

    @property
    def formatted_order_date(self):
        return shamsi_date(self.order_date)
...
class Transaction(AbstractBaseModel):
    ...
    def formatted_transaction_date(self):
        return shamsi_date(self.transaction_date)
