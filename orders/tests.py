...
class OrderModelTest(TestCase):
    def setUp(self):
        ...
        self.order = Order.objects.create(user=self.user, state='test_state', city='test_city', plate=12345, zip_code='12345', detail_address='Test Address', order_date=timezone.now(), total_price=100, payment_status=False, delivery_status='pending')
